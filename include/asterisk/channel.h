...
/*!
  \brief channel specific flags. Used currently for AMR NB to track mode 
*/
extern struct ast_flags ast_channel_options;
/*! channel options */
enum ast_channel_flags {
       /*! Octet aligned mode (for AMR NB) */
       AST_CHANNEL_OPT_FLAG_OCTET_ALIGN = (1<<0)
};
